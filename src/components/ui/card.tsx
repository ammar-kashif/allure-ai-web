  ...
  return (
    <div
      ...
      className={cn(
        ...
        /* Premium: compound shadow replaces flat ring, smooth hover lift */
        "shadow-[var(--shadow-card)] transition-[transform,box-shadow] duration-[var(--duration-normal)] ease-[var(--ease-out)]",
        className
      )}
      {...props}
    />
